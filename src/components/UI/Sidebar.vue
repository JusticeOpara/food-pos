...
<template>
  <!-- Desktop Sidebar -->
  <aside
    class="hidden md:flex md:w-24 bg-[#1F1D2B] min-h-screen flex-col items-center py-6 gap-8"
  >
    <!-- Logo -->
    <div
    ...
    <button
      @click="handleLogout"
      class="w-14 h-14 rounded-xl flex items-center justify-center text-[#EA7C69] hover:bg-[#252836] transition-all duration-300 group"
      title="Logout"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  <nav
    class="md:hidden fixed bottom-0 left-0 right-0 bg-[#1F1D2B] border-t border-[#252836] z-50 safe-area-inset-bottom"
  >
    <div class="flex items-center justify-around px-2 py-3 max-w-screen-sm mx-auto">
      <!-- Home -->
      <button
        @click="navigateTo('home')"
        :class="[
          'flex flex-col items-center justify-center gap-1 px-3 py-1 rounded-lg transition-all duration-300 min-w-[64px]',
          isActive('home')
            ? 'text-white'
            : 'text-[#EA7C69]/60',
        ]"
      >
        <div
          :class="[
            ...
            isActive('home')
              ? 'bg-[#EA7C69] shadow-lg shadow-[#EA7C69]/30'
              : 'bg-transparent',
          ]"
        >
          <svg
      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="M12 1v6m0 6v6m9-9h-6m-6 0H3m15.364 6.364l-4.243-4.243m-6 0l-4.242 4.243m12.485 0l-4.243-4.243m-6 0l-4.242 4.243"
            ></path>
          </svg>
        </div>
