<template>
  <div id="app" v-cloak>
    <div class="min-h-screen bg-[#1f1d2b] text-white p-8">
      <!-- Header -->
      ...
      <div class="grid grid-cols-3 gap-6 mb-8">
        ...
        >
          ...
          <button
            ...
            class="w-full bg-[#6c5248] hover:bg-[#7d6153] transition-colors py-4 flex items-center justify-center gap-2 text-sm"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
